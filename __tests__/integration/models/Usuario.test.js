...
// describe.skip("Usuário no momento do cadastro, fora da área logada.", () => {
//   beforeEach(async () => {
...
//     try {
//       const usuario = await factory.create("Usuario_Out",{ email: "vinicius@hotmail.com" })
//       const usuario_2 = await factory.create("Usuario_Out",{ email: "vinicius@hotmail.com" })
//     } catch(e) {
//       expect(String(e)).toBe("SequelizeUniqueConstraintError: Validation error");
//     }
//   })
// })